...
#ifndef __LIB_RTMP_AMF_H_INCLUDED__
#define __LIB_RTMP_AMF_H_INCLUDED__
...
#define amf_new_string_c(s)     amf_new(amf_string,(const char*)s,strlen(s))
...
/*return a amf object or null for invalid*/
...
/*encode object array ,return remain length of buf*/
int amf_encode_objects(amf_data_t *objs[],int n, char *buf, int maxlen);
